...
public class OdontogramaController implements Serializable {
    ...
    @EJB
    private com.historiaodontologica.sessionbeans.OdontogramaFacade ejbFacade;
    ...
    private OdontogramaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundlep").getString("OdontogramaCreated"));
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundlep").getString("PersistenceErrorOccured"));
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundlep").getString("OdontogramaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundlep").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundlep").getString("OdontogramaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundlep").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Odontograma getOdontograma(java.lang.Integer id) {
    ...
    public static class OdontogramaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getOdontograma(getKey(value));
        }
